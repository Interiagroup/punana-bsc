...
contract STOToken is ContextUpgradeable, AccessControlUpgradeable, ERC20Whitelisted, ERC20CappedUpgradeable, ERC20PausableUpgradeable {
    ...
    function initialize(string memory name, string memory symbol, uint256 supply,  uint8 sharesByToken, uint8 maxTokenMint, uint8 minTokenMint) public {
      __STOToken_init(name, symbol, supply, sharesByToken, maxTokenMint, minTokenMint);
    }

    function __STOToken_init(string memory name, string memory symbol, uint256 supply, uint8 sharesByToken, uint8 maxTokenMint, uint8 minTokenMint) internal initializer {
      ...
      __STOToken_init_unchained(sharesByToken, maxTokenMint, minTokenMint);
    }

    function __STOToken_init_unchained(uint8 sharesByToken, uint8 maxTokenMint, uint8 minTokenMint) internal initializer {
